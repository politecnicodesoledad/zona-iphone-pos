  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:title", content: "Zona iPhone — Celulares & Accesorios Apple en Barranquilla" },
        { property: "og:description", content: "Tienda Apple en Barranquilla: iPhone, iPad, MacBook y accesorios. Crédito, recibimos tu celular como pago. San Andresito El Pupi L23." },
        { name: "twitter:title", content: "Zona iPhone — Celulares & Accesorios Apple en Barranquilla" },
        { name: "twitter:description", content: "Tienda Apple en Barranquilla: iPhone, iPad, MacBook y accesorios. Crédito, recibimos tu celular como pago. San Andresito El Pupi L23." },
        { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f371e36b-9293-4fcd-8f78-0423f99c57bf/id-preview-0e664c15--8e023b18-96f1-4ba8-b3d4-515ba8f9b12d.lovable.app-1780274049489.png" },
        { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f371e36b-9293-4fcd-8f78-0423f99c57bf/id-preview-0e664c15--8e023b18-96f1-4ba8-b3d4-515ba8f9b12d.lovable.app-1780274049489.png" },
